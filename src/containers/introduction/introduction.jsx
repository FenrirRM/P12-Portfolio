  ...
  return (
    <section className="intro">
      ...
      <div className="intro__desc">
        <p>
          Je suis Mael Rehoudja, développeur web junior basé en côte d'or. Afin de suivre 
          ma passion pour les nouvelles technologies et la programmation, j’ai
        ...
        <p>
        En tant que développeur Front-end,  je suis constamment en train d'apprendre et 
        de m'adapter aux dernières technologies pour offrir des solutions de qualité à mes clients.
        </p>
        <p>
          Je suis très enthousiaste à l’idée de découvrir de nouvelles
          opportunités et collaborations pour créer des solutions web de qualité.
          <br />
